...
export const translations = {
  en: {
    ...
    'app-focus-description': 'This tool is optimized for short-term and daily trading analysis.',
  ...
  bg: {
    ...
    'app-focus-description': 'Този инструмент е оптимизиран за краткосрочен и дневен анализ.',
